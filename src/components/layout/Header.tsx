...
const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <>
      ...
      {/* Header container with logo and centered navigation */}
      <header
        className="fixed top-0 left-0 right-0 z-50 flex items-center justify-center w-full px-6 py-1 bg-gradient-to-b from-purple-950 to-purple-900 backdrop-blur-md border-b border-yellow-400/10"
        role="banner"
      >
        <div className="flex items-center gap-12">
          {/* Logo - Now visible on mobile too */}
          ...
          <nav className="navigation-menu hidden md:block" ref={navRef}>
            <ul>
          ...
          <button
            ...
            className="p-2 rounded-lg bg-purple-500/20 backdrop-blur-sm border border-purple-400/30 text-purple-100 hover:bg-purple-500/30 transition-colors hidden md:flex items-center gap-2"
          >
          ...
          {user ? (
            <div className="hidden md:flex items-center gap-4">
              <span className="text-yellow-100">Welcome, {user.name}</span>
              <button
                onClick={async () => {
                  await logout();
                  router.push("/");
                }}
                className="px-4 py-2 rounded-full bg-purple-900/40 backdrop-blur-sm border border-purple-400/30 text-purple-100 hover:bg-purple-500/30 transition-colors"
              >
                Logout
              </button>
            </div>
            ...
            <>
              ...
              <Link
                href="/signin"
                className="hidden md:flex px-4 py-2 rounded-full bg-purple-900/40 backdrop-blur-sm border border-purple-400/30 text-purple-100 hover:bg-purple-500/30 transition-colors"
              >
                Sign In
              </Link>
              ...
              <Link
                href="/signup"
                className="hidden md:flex px-4 py-2 rounded-full bg-gradient-to-r from-yellow-500 to-yellow-400 hover:from-yellow-400 hover:to-yellow-300 text-purple-900 font-semibold transition-all shadow-lg golden-glow"
              >
                Sign Up
              </Link>
            </>
